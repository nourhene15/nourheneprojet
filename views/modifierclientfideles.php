<?php
include "../entities/clientfideles.php";
include "../core/clientfidelesF.php";

$clientfidelesF= new clientfidelesF();


var_dump($_POST);
if( isset($_POST['id']) and isset($_POST['idClient']) and isset($_POST['PointsFidelite'])){
      ...
      $idClient=$_POST['idClient'];
       $PointsFidelite=$_POST['PointsFidelite'];
        $clientfideles = new clientfideles($idClient,$PointsFidelite);
         $clientfidelesF->modifierclientfideles($clientfideles,$_POST['id']);
...
<html lang="en">
  <head>
    ...
    <meta idClient="viewport" content="width=device-width, initial-scale=1">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="post" action="modifierclientfideles.php" class="form-horizontal form-label-left" novalidate>

                      <p>For alternative validation library <code>parsleyJS</code> check out in the <a href="form.html">form page</a>
                      </p>
                      <span class="section">modifier clientfideles  </span>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id">id <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  id="id" value="150" name="id" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
